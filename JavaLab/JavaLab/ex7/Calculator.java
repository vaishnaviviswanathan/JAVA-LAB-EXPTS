...
class CalculatorFrame extends JFrame
{
	...
	simpleActionListener simActionListener = new simpleActionListener();
	scientificActionListener sciActionListener = new scientificActionListener();
	...
	public CalculatorFrame() 
	{
		...
		helpMenu.setMnemonic('H');
			...
			helpItem.setAccelerator(KeyStroke.getKeyStroke("ctrl H"));
				helpItem.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent event)
					{
						JOptionPane.showMessageDialog(null,"For help, log on to \"www.javabeginner.com\"");
					}
				});
			...
			aboutItem.setAccelerator(KeyStroke.getKeyStroke("ctrl A"));
				aboutItem.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent event)
					{
						JOptionPane.showMessageDialog(null,"Creator : Keerthana ");
					}
				});
		...
		toolBar = new JToolBar();
			...
			JRadioButton simple = new JRadioButton("Simple");
				...
				simple.addActionListener(simActionListener);
			JRadioButton scientific = new JRadioButton("Scientific");
				scientific.addActionListener(sciActionListener);
		
			group.add(simple);
			group.add(scientific);

		toolBar.add(simple);
		toolBar.add(scientific);
	...
	public class simpleActionListener implements ActionListener
	{
		public void actionPerformed(ActionEvent event)
		{
			ScientificCalculatorFrame f = new ScientificCalculatorFrame();
			setVisible(true);
			f.setVisible(false);
		}
	}
...
{	
	...
	public ScientificCalculatorFrame()
	{
		...
		add(scientificCalculatorPanel,BorderLayout.CENTER);
...
class ScientificCalculatorPanel extends JPanel
{
	...
	//evaluation of the postfix expression
		...
		for(i=0;i<j;i++)
		{
			...
			else if(((int)postfix_expr[i].charAt(0) >= 48 && (int)postfix_expr[i].charAt(0) <= 57) || postfix_expr[i].charAt(0) == '.')
