...
if (superfish.b && superfish.b.qsObj && superfish.b.qsObj.sflog == "-999") {
    if(!correctJqVersion) {
        ...
        superfish.b.appVersion="12.2.14.5";
...
superfish.b.inimgDisplayBox=4;
superfish.b.inImageextands=0;
...
//        }    
    ...
    customActions: {
        ...
        superfish.b.fullUIMaxHeight = 555;
...
;
           if (spsupport.br.isIE7){
               ...
               superfish.partner._logoClick = function() {
       if (window.conduitToolbarCB) {
...
//        }
    ...
    ih : function(it, i, ind) {
        if (it) {
            ...
            var bg = t.isIEQor8 ? 'background-color: #454545; ' : (t.b.testMt ? 'background-color: rgba(70, 70, 70, 0.8); ' : 'background-color: rgba(70, 70, 70, 0.9); ');
            ...
            return(
                ...
                '       <img id= "SF_II_LOADOV_' + ind +'_'+ i + '" src = "' + t.sp.src + '" style="width:'+ is3 +'px; height: '+ is3 +'px; display: inline-block; border: none;" />' +
                    '<div class="itemDetails" style = "'+itemDetails+'">' +
                     '<div style="margin-top: ' + (t.p.isIEQ ? 0 : 6) + 'px; margin-left: 7px;">' +
                     (t.b.testMt ? 
                        '<div class="visData">' +
                        '    <span class="price"  style = "'+price+'">' + pr + '</span>' +
                        '    <span class="add" style = "'+add+'">' + elSt + '</span>' +
                        '</div>' : '') +
